...
const SideDrawer = () => {
    ...
    return ( <
        ...
        /> < /
        MenuButton > <
        MenuList pl = { 2 } > {!notification.length && "No Messages" } {
            notification.map(notify => ( <
                ...
                onClick = {
                    ...
                    notify.chat.isGroupChat ? 'New Message from ${notif.chat.chatName}' : `New Message from ${getSender(user, notify.chat.users)}`
                } <
                /MenuItem>
